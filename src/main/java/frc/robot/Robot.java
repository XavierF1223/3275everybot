...
public class Robot extends TimedRobot {
   ...
   */
  TalonFX driveLeftSpark = new TalonFX (1);
  TalonFX driveRightSpark = new TalonFX(2);
  TalonFX driveLeftVictor = new TalonFX(3);
  TalonFX driveRightVictor = new TalonFX(4);
  ...
  public void robotInit() {
    ...
    arm.configStatorCurrentLimit(new StatorCurrentLimitConfiguration(true, ARM_CURRENT_LIMIT_A, ARM_CURRENT_LIMIT_A+5,0.5));
  ...
  public void setIntakeMotor(double percent, int amps) {
    ...
    intake.configContinuousCurrentLimit(amps, 1);
    SmartDashboard.putNumber("intake power (%)", percent);
    SmartDashboard.putNumber("intake motor current (amps)", intake.getStatorCurrent());
    SmartDashboard.putNumber("intake motor temperature (C)", intake.getTemperature());
  }
